  ...
  wom::AutoCommands c = *new wom::AutoCommands(
      {// {"ArmToSetPoint", [_alphaArm]() { return wom::make<ArmToSetPoint>(_alphaArm, 20_deg); }},
       // {"Shoot", [_shooter]() { return wom::make<AutoShoot>(_shooter); }},
        ...
        {"EuanTurningFromLeftToFirst", [_swerveDrive]() { return wom::make<wom::TurnToAngleBehaviour>(_swerveDrive, 45_deg); }},
        {"EuanTurningFromLeftToSecond", [_swerveDrive]() { return wom::make<wom::TurnToAngleBehaviour>(_swerveDrive, 80_deg); }},
        {"EuanTurningFromSecondToSHOOT", [_swerveDrive]() { return wom::make<wom::TurnToAngleBehaviour>(_swerveDrive, 10_deg); }},
        {"EuanTurningFromFirstToShoot", [_swerveDrive]() { return wom::make<wom::TurnToAngleBehaviour>(_swerveDrive, 50_deg); }},
      });
